...
Execute the skill at `~/.claude/plugins/insight-extractor/skills/insight-extractor` or `~/.claude/plugins/cache/masayan-uni-plugins/insight-extractor/skills/insight-extractor` to extract valuable insights from the provided URL or text.
